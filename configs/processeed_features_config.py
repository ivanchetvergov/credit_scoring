...
#     'BUREAU_AMT_CREDIT_MAX_OVERDUE_MEAN', 'BUREAU_AMT_CREDIT_SUM_DEBT_MEAN',
...
#     'DEF_30_CNT_SOCIAL_CIRCLE', 'EXT_SOURCE_1', 'EXT_SOURCE_2',
#     'EXT_SOURCE_3', 'PREV_AMT_ANNUITY_MEAN', 'PREV_AMT_APPLICATION_MAX',
#     'PREV_AMT_DOWN_PAYMENT_SUM', 'PREV_CNT_PAYMENT_MAX', 'PREV_CNT_PAYMENT_MEAN',
#     'PREV_CNT_PAYMENT_MIN', 'PREV_DAYS_DECISION_MAX',
#     'PREV_DAYS_FIRST_DRAWING_MEAN', 'PREV_DAYS_FIRST_DRAWING_MIN',
#     'PREV_DAYS_FIRST_DRAWING_SUM', 'PREV_DAYS_FIRST_DUE_MIN',
#     'PREV_DAYS_LAST_DUE_1ST_VERSION_MAX', 'PREV_DAYS_LAST_DUE_MAX',
#     'PREV_DAYS_LAST_DUE_MEAN', 'PREV_DAYS_LAST_DUE_SUM',
#     'REGION_RATING_CLIENT_W_CITY',
#     # Категориальные
#     'CODE_GENDER', 'NAME_CONTRACT_TYPE', 'NAME_EDUCATION_TYPE', 'NAME_FAMILY_STATUS',
#     # Бинарные
#     'FLAG_OWN_CAR',
# ]