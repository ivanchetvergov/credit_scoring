...
NUMERICAL_FEATURES += [
    ...
    'BUREAU_AMT_ANNUITY_P25',
    'BUREAU_AMT_ANNUITY_P75',
    'BUREAU_AMT_CREDIT_MAX_OVERDUE_STD',
    'BUREAU_AMT_CREDIT_MAX_OVERDUE_P25',
    'BUREAU_AMT_CREDIT_MAX_OVERDUE_P75',
    'BUREAU_AMT_CREDIT_SUM_DEBT_STD',
    'BUREAU_AMT_CREDIT_SUM_DEBT_P25',
    'BUREAU_AMT_CREDIT_SUM_DEBT_P75',
    'BUREAU_AMT_CREDIT_SUM_LIMIT_STD',
    'BUREAU_AMT_CREDIT_SUM_LIMIT_P25',
    'BUREAU_AMT_CREDIT_SUM_LIMIT_P75',
    'BUREAU_AMT_CREDIT_SUM_OVERDUE_STD',
    'BUREAU_AMT_CREDIT_SUM_OVERDUE_P25',
    'BUREAU_AMT_CREDIT_SUM_OVERDUE_P75',
    'BUREAU_AMT_CREDIT_SUM_STD',
    'BUREAU_AMT_CREDIT_SUM_P25',
    'BUREAU_AMT_CREDIT_SUM_P75',
    'BUREAU_BB_HISTORY_LENGTH_STD',
    'BUREAU_BB_HISTORY_LENGTH_P25',
    'BUREAU_BB_HISTORY_LENGTH_P75',
    'BUREAU_BB_STATUS_PCT_0_STD',
    'BUREAU_BB_STATUS_PCT_0_P25',
    'BUREAU_BB_STATUS_PCT_0_P75',
    'BUREAU_BB_STATUS_PCT_1_STD',
    'BUREAU_BB_STATUS_PCT_1_P25',
    'BUREAU_BB_STATUS_PCT_1_P75',
    'BUREAU_BB_STATUS_PCT_2_STD',
    'BUREAU_BB_STATUS_PCT_2_P25',
    'BUREAU_BB_STATUS_PCT_2_P75',
    'BUREAU_BB_STATUS_PCT_3_STD',
    'BUREAU_BB_STATUS_PCT_3_P25',
    'BUREAU_BB_STATUS_PCT_3_P75',
    'BUREAU_BB_STATUS_PCT_4_STD',
    'BUREAU_BB_STATUS_PCT_4_P25',
    'BUREAU_BB_STATUS_PCT_4_P75',
    'BUREAU_BB_STATUS_PCT_5_STD',
    'BUREAU_BB_STATUS_PCT_5_P25',
    'BUREAU_BB_STATUS_PCT_5_P75',
    'BUREAU_BB_STATUS_PCT_C_STD',
    'BUREAU_BB_STATUS_PCT_C_P25',
    'BUREAU_BB_STATUS_PCT_C_P75',
    'BUREAU_BB_STATUS_PCT_X_STD',
    'BUREAU_BB_STATUS_PCT_X_P25',
    'BUREAU_BB_STATUS_PCT_X_P75',
    'BUREAU_CNT_CREDIT_PROLONG_STD',
    'BUREAU_CNT_CREDIT_PROLONG_P25',
    'BUREAU_CNT_CREDIT_PROLONG_P75',
    'BUREAU_CREDIT_DAY_OVERDUE_STD',
    'BUREAU_CREDIT_DAY_OVERDUE_P25',
    'BUREAU_CREDIT_DAY_OVERDUE_P75',
    'BUREAU_DAYS_CREDIT_ENDDATE_STD',
    'BUREAU_DAYS_CREDIT_ENDDATE_P25',
    'BUREAU_DAYS_CREDIT_ENDDATE_P75',
    'BUREAU_DAYS_CREDIT_STD',
    'BUREAU_DAYS_CREDIT_UPDATE_STD',
    'BUREAU_DAYS_CREDIT_UPDATE_P25',
    'BUREAU_DAYS_CREDIT_UPDATE_P75',
    'BUREAU_DAYS_CREDIT_P25',
    'BUREAU_DAYS_CREDIT_P75',
    'BUREAU_DAYS_ENDDATE_FACT_STD',
    'BUREAU_DAYS_ENDDATE_FACT_P25',
    'BUREAU_DAYS_ENDDATE_FACT_P75',
    'CREDIT_INCOME_RATIO',
