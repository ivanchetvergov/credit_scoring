...
NUMERICAL_FEATURES += [
    ...
    'ANNUITY_INCOME_RATIO_SQ',
    'BUREAU_AMT_ANNUITY_STD',
    'BUREAU_AMT_ANNUITY__Q25',
    'BUREAU_AMT_ANNUITY__Q75',
    'BUREAU_AMT_CREDIT_MAX_OVERDUE_STD',
    'BUREAU_AMT_CREDIT_MAX_OVERDUE__Q25',
    'BUREAU_AMT_CREDIT_MAX_OVERDUE__Q75',
    'BUREAU_AMT_CREDIT_SUM_DEBT_STD',
    'BUREAU_AMT_CREDIT_SUM_DEBT__Q25',
    'BUREAU_AMT_CREDIT_SUM_DEBT__Q75',
    'BUREAU_AMT_CREDIT_SUM_LIMIT_STD',
    'BUREAU_AMT_CREDIT_SUM_LIMIT__Q25',
    'BUREAU_AMT_CREDIT_SUM_LIMIT__Q75',
    'BUREAU_AMT_CREDIT_SUM_OVERDUE_STD',
    'BUREAU_AMT_CREDIT_SUM_OVERDUE__Q25',
    'BUREAU_AMT_CREDIT_SUM_OVERDUE__Q75',
    'BUREAU_AMT_CREDIT_SUM_STD',
    'BUREAU_AMT_CREDIT_SUM__Q25',
    'BUREAU_AMT_CREDIT_SUM__Q75',
    'BUREAU_BB_HISTORY_LENGTH_STD',
    'BUREAU_BB_HISTORY_LENGTH__Q25',
    'BUREAU_BB_HISTORY_LENGTH__Q75',
    'BUREAU_BB_STATUS_PCT_0_STD',
    'BUREAU_BB_STATUS_PCT_0__Q25',
    'BUREAU_BB_STATUS_PCT_0__Q75',
    'BUREAU_BB_STATUS_PCT_1_STD',
    'BUREAU_BB_STATUS_PCT_1__Q25',
    'BUREAU_BB_STATUS_PCT_1__Q75',
    'BUREAU_BB_STATUS_PCT_2_STD',
    'BUREAU_BB_STATUS_PCT_2__Q25',
    'BUREAU_BB_STATUS_PCT_2__Q75',
    'BUREAU_BB_STATUS_PCT_3_STD',
    'BUREAU_BB_STATUS_PCT_3__Q25',
    'BUREAU_BB_STATUS_PCT_3__Q75',
    'BUREAU_BB_STATUS_PCT_4_STD',
    'BUREAU_BB_STATUS_PCT_4__Q25',
    'BUREAU_BB_STATUS_PCT_4__Q75',
    'BUREAU_BB_STATUS_PCT_5_STD',
    'BUREAU_BB_STATUS_PCT_5__Q25',
    'BUREAU_BB_STATUS_PCT_5__Q75',
    'BUREAU_BB_STATUS_PCT_C_STD',
    'BUREAU_BB_STATUS_PCT_C__Q25',
    'BUREAU_BB_STATUS_PCT_C__Q75',
    'BUREAU_BB_STATUS_PCT_X_STD',
    'BUREAU_BB_STATUS_PCT_X__Q25',
    'BUREAU_BB_STATUS_PCT_X__Q75',
    'BUREAU_CNT_CREDIT_PROLONG_STD',
    'BUREAU_CNT_CREDIT_PROLONG__Q25',
    'BUREAU_CNT_CREDIT_PROLONG__Q75',
    'BUREAU_CREDIT_DAY_OVERDUE_STD',
    'BUREAU_CREDIT_DAY_OVERDUE__Q25',
    'BUREAU_CREDIT_DAY_OVERDUE__Q75',
    'BUREAU_DAYS_CREDIT_ENDDATE_STD',
    'BUREAU_DAYS_CREDIT_ENDDATE__Q25',
    'BUREAU_DAYS_CREDIT_ENDDATE__Q75',
    'BUREAU_DAYS_CREDIT_STD',
    'BUREAU_DAYS_CREDIT_UPDATE_STD',
    'BUREAU_DAYS_CREDIT_UPDATE__Q25',
    'BUREAU_DAYS_CREDIT_UPDATE__Q75',
    'BUREAU_DAYS_CREDIT__Q25',
    'BUREAU_DAYS_CREDIT__Q75',
    'BUREAU_DAYS_ENDDATE_FACT_STD',
    'BUREAU_DAYS_ENDDATE_FACT__Q25',
    'BUREAU_DAYS_ENDDATE_FACT__Q75',
    'CREDIT_INCOME_RATIO',
    'CREDIT_INCOME_RATIO_SQ',
    'CREDIT_TERM_EST',
    'DAYS_EMPLOYED_ANOM',
    'DOCUMENTS_SUBMITTED',
    'DOWN_PAYMENT_PROXY',
...
# Удаляем дублирующие признаки, чтобы не было повторов
NUMERICAL_FEATURES = list(dict.fromkeys(NUMERICAL_FEATURES))
CATEGORICAL_FEATURES = list(dict.fromkeys(CATEGORICAL_FEATURES))
BIN_CATEGORICAL_FEATURES = list(dict.fromkeys(BIN_CATEGORICAL_FEATURES))

if __name__ == '__main__':
    total_features = (
        len(NUMERICAL_FEATURES) +
        len(CATEGORICAL_FEATURES) +
        len(BIN_CATEGORICAL_FEATURES)
    )
    print(f"Всего фичей для модели: {total_features}")
    print(f"Обнаружено числовых: {len(NUMERICAL_FEATURES)}")
    print(f"Обнаружено категориальных (строковых): {len(CATEGORICAL_FEATURES)}")
    print(f"Обнаружено бинарных (0/1): {len(BIN_CATEGORICAL_FEATURES)}")
